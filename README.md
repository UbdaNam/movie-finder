...
# 📖 Movie-Finder <a name="about-project">

Hi there! Welcome to Movie-Finder</a>

Movie Finder is a web-based application that allows users to search for movies.
...
```snippet
  git clone https://github.com/UbdaNam/movie-finder.git
```
...
Feel free to check the [issues page](https://github.com/UbdaNam/movie-finder/issues).
...
- This project is built using [TMDb API](https://developers.themoviedb.org/3/getting-started/introduction) free API.
